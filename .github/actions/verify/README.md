...
**Pin SDK:** `matrixscroll-version: "0.8.0"` (recommended). The action installs
**0.8.0** when the input is omitted.

**Release line policy:** current line **0.8.x**; the previous minor release line
...
| `matrixscroll-version` | both | `0.8.0` | SDK version pin |
...
- PyPI release provenance: <https://pypi.org/project/matrixscroll/0.8.0/>
