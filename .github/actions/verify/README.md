...
**Pin SDK:** `matrixscroll-version: "0.9.0"` (recommended). The action installs
**0.9.0** when the input is omitted.
...
| `matrixscroll-version` | both | `0.9.0` | SDK version pin |
...
- PyPI release provenance: <https://pypi.org/project/matrixscroll/0.9.0/>
