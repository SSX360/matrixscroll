...
**Windows:** support landed in matrixscroll **0.2.1**; pin **0.5.1** in pilot environments.
...
Policy flags (`--require-mode`, `--trusted-keys`) ship in the current release; this whitepaper pins `0.5.1` for copy-and-paste examples.
