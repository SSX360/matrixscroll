...
Windows support landed in **matrixscroll 0.2.1**. Pin `0.6.4` after upgrading:

```powershell
pip install -U "matrixscroll==0.6.4"
matrixscroll hook-install
```
...
1. Install `matrixscroll==0.6.4` and `matrixscroll hook-install` in the repo.
