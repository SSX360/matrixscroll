...
Windows support landed in **matrixscroll 0.2.1**. Pin `0.6.3` after upgrading:

```powershell
pip install -U "matrixscroll==0.6.3"
matrixscroll hook-install
```
...
1. Install `matrixscroll==0.6.3` and `matrixscroll hook-install` in the repo.
