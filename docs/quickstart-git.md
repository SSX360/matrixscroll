...
Windows support landed in **matrixscroll 0.2.1**. Pin `0.7.0` after upgrading:

```powershell
pip install -U "matrixscroll==0.7.0"
matrixscroll hook-install
```
...
1. Install `matrixscroll==0.7.0` and `matrixscroll hook-install` in the repo.
